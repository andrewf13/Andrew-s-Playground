...
function EverestSoftwareRenderer(canvas,T){
 ...
 function mesh(o,wm){if(o.userData.skipSoftware)return;const g=o.userData.softwareGeometry||o.geometry;if(!g)return;const p=g.attributes.position,colors=g.attributes.color,index=g.index,m=Array.isArray(o.material)?o.material[0]:o.material;if(!m||!p||m.opacity===0)return;matrix.multiplyMatrices(view,wm);const verts=new Array(p.count);
